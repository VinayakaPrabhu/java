package com.collection_key_concepts;
...
public class CollectionConcepts {
	public static void main(String[] args) {
		...
		/*
		 * Iterator<Product> iterator = products.iterator(); while (iterator.hasNext())
		 * { final Product product = iterator.next(); if (product.getWeight() > 20) {
		 * System.out.println(product); } else { iterator.remove(); } }
		 */
